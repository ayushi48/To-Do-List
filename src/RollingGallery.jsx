...
//   "/homewith task.png",
// "homewithouttask.png",
// "importantwithtask.png",
// "laptracker.png",
// "onlystopwatch.png",
// "timer.png",
// "importantwithouttask.png",
// "calender.png"
...
//                 src={url}
//                 alt="gallery"
//                 className="pointer-events-none h-[200px] w-[500px] rounded-[15px] border-[3px] border-white object-cover
          ...
          {images.map((url, i) => (
            ...
            >
              <img
                src={url}
                alt={`gallery-${i}`}
                className="pointer-events-none h-[300px] w-[800px] rounded-[20px] border-[4px] border-white object-cover
                  transition-transform duration-300 ease-out group-hover:scale-105
                  sm:h-[200px] sm:w-[400px]"
              />
            </div>
          ))}
        </motion.div>
